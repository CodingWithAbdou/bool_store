            ...
            <div class="grid grid-cols-1  sm:grid-cols-2  md:grid-cols-3  xl:grid-cols-4  justify-center">
                @foreach ($books as $book)
                    @if ($book->number_of_copies > 0)
                        <div class="m-3">
                            <div class="relative m-10 w-full max-w-xs overflow-hidden rounded-lg bg-white shadow-md mx-auto transition hover:shadow-2xl ">
                                <a href="{{ route('book.justshow' , $book) }}">
                                ...
                                <div class="mt-4 px-5 pb-5">
                                    ...
                                    <div class="mt-2.5 mb-5 flex items-center relative">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <a href="#" data-book="{{$book->id}}" class="addTocart flex items-center rounded-md bg-slate-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
