                        ...
                        <thead class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th colspan='2' class="px-6 py-3 rounded-lg">
                                    <h2 class="text-xl">إضافة تصنيف</h2>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="bg-white dark:bg-gray-800 border-b">
                                ...
                                <td class="px-6 py-4">
                                    <input name="name" type="text" class="form-control  @error('name') is-invalid @enderror" id="" placeholder="إسم الكتاب" value="{{ old('name') }}" >
                                    @error('name')
                            ...
                            <tr class="bg-white dark:bg-gray-800  border-b">
                                <td colspan="2" class="px-6 py-4 " >
                                    <div class="flex items-center w-fit mx-auto rounded-md  px-5 py-2.5 text-center text-sm font-medium">
                                        <button role="submit" href="{{ route('categories.store') }}" class="btn cur-p btn-success btn-color me-2">
                                            حفظ
                                        </button>
                                    </div>
                                </td>
