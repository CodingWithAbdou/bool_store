                        ...
                        <thead class="text-xs text-gray-700 uppercase bg-gray-100 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                <th colspan='2' class="px-6 py-3 rounded-lg">
                                    <h2 class="text-xl">تعديل  المؤلف</h2>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr class="bg-white dark:bg-gray-800 border-b">
                                ...
                                <td class="px-6 py-4">
                                    <input name="name" type="text" class="form-control  @error('name') is-invalid @enderror" id="" placeholder="إسم  المؤلف" value="{{ $author->name }}" >
                                    @error('name')
                            ...
                            <tr class="bg-white dark:bg-gray-800  border-b">
                                ...
                                <td class="px-6 py-4 ">
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description" rows="3" placeholder="وصف المؤلف" >{{ $author->description}}</textarea>
                                    @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
